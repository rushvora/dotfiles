# Generated by Powerlevel10k configuration wizard on 2022-05-10 at 16:00 IST.
...
# flat tails, 2 lines, disconnected, no frame, compact, fluent, instant_prompt=verbose.
...
() {
  ...
  typeset -g POWERLEVEL9K_DIR_FOREGROUND=235 # rv custom
  ...
  typeset -g POWERLEVEL9K_DIR_SHORTENED_FOREGROUND=233 # rv custom
  # Color of the anchor directory segments. Anchor segments are never shortened. The first
  # segment is always an anchor.
  # typeset -g POWERLEVEL9K_DIR_ANCHOR_FOREGROUND=255
  typeset -g POWERLEVEL9K_DIR_ANCHOR_FOREGROUND=232 # rv custom
  ...
  typeset -g POWERLEVEL9K_VCS_PREFIX='' # rv custom
  ...
  typeset -g POWERLEVEL9K_KUBECONTEXT_PREFIX='' # rv custom
  ...
  typeset -g POWERLEVEL9K_TOOLBOX_PREFIX='' # rv custom
  ...
  typeset -g POWERLEVEL9K_TIME_PREFIX='' # rv custom
  ...
  typeset -g POWERLEVEL9K_INSTANT_PROMPT=quiet # rv custom
